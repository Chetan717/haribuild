...
export default function Activetp({ setActive, HandleDelete }) {
            ...
            return (
              <>
                <Card>
                        ...
                        >
                          ...
                          >
                            <div className="flex flex-row gap-3 ">
                              <p
                                onClick={() => setActive(i._id, true, getTp)}
                                className="bg-black text-xs rounded-lg text-white p-1.5"
                              >
                                Active
                              </p>
                              <p
                                onClick={() => setActive(i._id, false, getTp)}
                                className="bg-black text-xs rounded-lg text-white p-1.5 "
                              >
                                UnActive
                              </p>
                  ...
                  {moment(i?.lastDate).format("DD/MM/YYYY") === moment(new Date()).format("DD/MM/YYYY") ? (
                    <span class="absolute flex justify-end items-start  h-full w-full">
                      ...
                      <span class="m-2 inline-flex text-black bg-yellow-400 shadow-lg p-2 rounded-lg text-xs font-bold"> 🛑 Today is Expiry!</span>
                    </span>
                  ) : null}
                </Card>
              </>
